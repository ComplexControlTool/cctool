...
(function ()
{
    ...
    CreateGraphController.$inject = ['$rootScope', '$scope', '$q', '$timeout', '$state', '$stateParams', '$mdToast', '$mdMedia', '$mdDialog', '$cookies', 'api', 'settingsService'];

    /** @ngInject */
    function CreateGraphController($rootScope, $scope, $q, $timeout, $state, $stateParams, $mdToast, $mdMedia, $mdDialog, $cookies, api, settingsService)
    {
        var vm = this;
