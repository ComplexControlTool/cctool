...
(function ()
{
    ...
    function UpdateGraphController(Graph, $rootScope, $scope, $q, $timeout, $state, $stateParams, $mdToast, $mdMedia, $mdDialog, $cookies, $log, api, settingsService)
    {
        ...
        function init()
        {
          ...
          {
            $log.debug(vm.title + '/ Graph given is empty, returning to main page.');
          }
          ...
          vm.maxStep = 3;
          vm.stepData = [
            { step: 1, completed: false, optional: false, data: vm.content },
        ...
        function submitGraph(stepId)
        {
          ...
          var unsuccessfulCall = function(response)
          {
            $mdToast.show(
              $mdToast.simple()
                .textContent('Unable to update graph!')
          ...
          if (!vm.stepData[stepId].completed)
          {
            ...
            vm.content.$update(successfulCall,unsuccessfulCall);
          }
        }
    }
})();