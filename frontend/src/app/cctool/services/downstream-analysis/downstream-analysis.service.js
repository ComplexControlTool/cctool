// downstream-analysis.service.js
(function()
{
  'use strict';

  angular
    .module('app.cctool.services.downstream-analysis')
    .service('downstreamAnalysisService', downstreamAnalysisService);

  /* @ngInject */
  function downstreamAnalysisService($log, $rootScope, $interval, apiResolver)
  {
    /* jshint validthis: true */
    var vm = this;
    
    // Data
    vm.title = 'downstreamAnalysisService';
    ...
    function requestAndNotify(graphId)
    {
      ...
      var analysisType = 'Intervention Analysis';
                ...
                apiResolver.resolve('cctool.analysis.full@query', {'graphId': graphId, 'analysisType': analysisType}).then(
                  function(data)
                  {
                    ...
                    if (data && data[0])
                    {
                      ...
                      $rootScope.$broadcast('downstreamAnalysis:hasUpdates',monitoredAnalysis);
