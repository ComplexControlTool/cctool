# Generated by Django 2.0.9 on 2019-02-17 19:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('options', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_index=True, default=dict, null=True)),
                ('structure', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_index=True, default=dict, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_index=True, default=list, null=True)),
                ('custom', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_index=True, default=dict, null=True)),
            ],
            options={
                'verbose_name': 'edge',
                'verbose_name_plural': 'edges',
