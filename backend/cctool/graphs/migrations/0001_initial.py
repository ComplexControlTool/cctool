# Generated by Django 2.0.9 on 2019-09-30 15:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created datetime stamp')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Last updated datetime stamp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created datetime stamp')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Last updated datetime stamp')),
                ('identifier', models.CharField(default='-1', max_length=100, verbose_name='identifier of edge')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created datetime stamp')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Last updated datetime stamp')),
                ('identifier', models.CharField(default='-1', max_length=40, verbose_name='identifier of node')),
